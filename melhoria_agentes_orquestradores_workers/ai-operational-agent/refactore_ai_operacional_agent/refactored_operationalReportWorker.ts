...
interface RefactoredWorkerContext {
  operationalData: { // Dados operacionais já pré-buscados pelo orquestrador
    allOrders: any[];
    createdOrders: any[];
    completedOrders: any[];
    occurrences: any[];
...
export async function executeOperationalReportWorker(ctx: RefactoredWorkerContext): Promise<RefactoredWorkerResult> {
