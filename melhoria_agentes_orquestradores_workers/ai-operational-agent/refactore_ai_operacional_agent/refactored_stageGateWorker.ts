...
export async function executeStageGateWorker(ctx: RefactoredWorkerContext): Promise<RefactoredWorkerResult> {
  ...
  let notifications: Array<{ template_key: string; entity_type: string; entity_id: string; metadata: any }> = [];
