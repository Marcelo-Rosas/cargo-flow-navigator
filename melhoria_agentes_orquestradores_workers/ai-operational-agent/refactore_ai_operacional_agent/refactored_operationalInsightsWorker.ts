...
interface RefactoredWorkerContext {
  operationalData: { // Dados operacionais já pré-buscados e agregados pelo orquestrador
    orders: any[];
    occurrences: any[];
...
export async function executeOperationalInsightsWorker(ctx: RefactoredWorkerContext): Promise<RefactoredWorkerResult> {
